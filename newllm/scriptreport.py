# 2. REPORT GENERATOR - Gera relatórios formatados
...
"""
        ...
        automacoes_rapidas = [auto for auto in profile.automacoes_sugeridas if 'relatório' in auto or 'conciliação' in auto][:2]
...
"""
        ...
        automacoes_complexas = [auto for auto in profile.automacoes_sugeridas if auto not in automacoes_rapidas]
...
**⚡ AÇÃO IMEDIATA**
{insights['urgencias'][0] if profile.urgencias else 'Planejar implementação gradual'}
...
"""
    ...
    def _definir_acao_urgencia(self, urgencia: str) -> tuple:
        ...
        acoes = {
            "ECF com prazo próximo": ("3 dias", "Organizar documentos e transmitir ECF"),
            "SPED Fiscal pendente": ("7 dias", "Revisar movimentação e enviar SPED"),
            "Folha de pagamento em atraso": ("2 dias", "Processar e enviar folha urgentemente")
        }
    ...
    def _definir_detalhes_automacao(self, automacao: str) -> tuple:
        ...
        detalhes = {
            "Automação de lançamento de NF-e": ("30 dias", "R$ 2.000", "40h/mês economizadas"),
            "Automação da conciliação bancária": ("20 dias", "R$ 1.500", "20h/mês economizadas"),
            "Automação da folha de pagamento": ("45 dias", "R$ 3.000", "30h/mês economizadas"),
            "Geração automática de relatórios": ("15 dias", "R$ 1.000", "15h/mês economizadas")
        }
...
def exemplo_completo():
    ...
    print(generator.gerar_relatorio_completo(profile, insights))
    
    print("\\n\\n=== PLANO DE AÇÃO ===")
    print(generator.gerar_plano_acao(profile, insights))
...
print("✅ report_generator.py criado com sucesso!")
print("Contém:")
print("- Geração de relatório completo formatado")
print("- Plano de ação com cronograma")  
print("- Relatório executivo resumido")
print("- Cálculos de ROI e payback")
print("- Templates personalizados para Telegram")